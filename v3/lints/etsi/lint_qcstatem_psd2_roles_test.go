...
func TestQcStatemPsd2RolesTestCerts(t *testing.T) {
	m := map[string]lint.LintStatus{
		"QcStmtPsd2Cert01InvalidRoles.pem":                lint.Error,
		...
		"QcStmtPsd2Cert16RoleIdAndNameInconsistent.pem":   lint.Error,
		...
		"QcStmtPsd2Cert48LegalPersonSyntaxViolated.pem":   lint.Pass,
		"QcStmtPsd2Cert50CabfNtrSopSyntaxInPsd2Cert.pem":  lint.Pass,
		"QcStmtPsd2Cert51ValidNoQcs2QcStmt.pem":           lint.Pass,
		"EvAltRegNumCert56JurContryNotMatching.pem":       lint.NA,
	}
	for inputPath, expected := range m {
		out := test.TestLint("e_qcstatem_psd2_roles", inputPath)
